...
const regPatient = () => {
  const register = async (values,onSubmitProps)=> {
    try {
      const response = await fetch("http://localhost:5001/auth/regPatient", {
        method: "POST",
  ...
  return (
    <>
      <form  onSubmit={formik.handleSubmit}>
                  <h1>Patient regisration form </h1>
                  ...
                  <div className="w-[100%] text-left">
                    ...
                    <div className="flex justify-between gap-10">
                    <TextField
                      name="admissionReaasons"
                          id="outlined-multiline-flexible"
                          label='Reason for registration'
                          values={formik.values.admissionReaasons}
                          maxRows={2}
                          helperText={formik.touched.admissionReaasons && formik.errors.admissionReaasons ? formik.errors.admissionReaasons:''}
                          onBlur={formik.handleBlur}
                      onChange={formik.handleChange}
                      sx={{
                      margin:'10px 0',
                    ...
                    values={formik.values.admissionDesc}
                    helperText={formik.touched.admissionDesc && formik.errors.admissionDesc ? formik.errors.admissionDesc:''}
                          onBlur={formik.handleBlur}
                      onChange={formik.handleChange}
                  />
                      </div>
